jQuery.noConflict()(function ($) {
	...
	$("#slide_prev").on("click", function(){
      ...
      if ( $('#'+prev).is( ":checked" ) ){ 
          ...
          $('input[name="slider"]').removeAttr("checked");   
        document.getElementById(prev).setAttribute("checked", true );
        if(prev === "slider_2"){
            document.getElementById("slide_prev").setAttribute("prev", "slider_1" );
             document.getElementById("slide_next").setAttribute("next", "slider_2" );
        }else{
            if(prev === "slider_1"){
            document.getElementById("slide_prev").setAttribute("prev", "slider_1" );
             document.getElementById("slide_next").setAttribute("next", "slider_2" );
   ...
   $("#slide_next").on("click", function(){
      var next = $(this).attr('next');
       if ( $('#'+next).is( ":checked" ) ){
        ...
        $('input[name="slider"]').removeAttr("checked");   
        document.getElementById(next).setAttribute("checked", true );
        if(next === "slider_2"){
            document.getElementById("slide_next").setAttribute("next", "slider_3" );
             document.getElementById("slide_prev").setAttribute("prev", "slider_1" );
        }else{
            if(next === "slider_3"){
            document.getElementById("slide_next").setAttribute("next", "slider_3" );
             document.getElementById("slide_prev").setAttribute("prev", "slider_2" );
        }
        }
       }
   });
...
autoplayTimeout: 5000,
			...
			animateOut: 'fadeOut',
			navElement: 'a class="oi_crea_a"',
			navText: ['<img width="28" alt="" src="{{url('/')}}/img/arr_l.png">', '<img width="28" alt="" src="{{url('/')}}/img/arr_r.png">'],
			margin: 0,
			autoplayHoverPause: false,
			items: 1
 })
